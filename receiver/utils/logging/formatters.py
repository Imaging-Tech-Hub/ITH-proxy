...
class ColoredFormatter(logging.Formatter):
    """Colored console formatter without icons."""
    ...
    def format(self, record):
        ...
        if levelname_orig in self.COLORS:
            record.levelname = (
                f"{self.COLORS[levelname_orig]}{self.BOLD}{levelname_orig}{self.RESET}"
            )
...
class CompactFormatter(logging.Formatter):
    """Compact formatter for minimal output without icons."""
    ...
    def format(self, record):
        ...
        return f"[{record.levelname}] [{record.module}] {message}"
